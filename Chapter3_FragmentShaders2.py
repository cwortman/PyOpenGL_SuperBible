"""
PyOpenGL OpenGL SuperBible Chapter 3 Fragment Shaders 2

Vertex shader sends color to fragment shader for each vertex of a moving
...
class MainWidget(QOpenGLWidget):
    ...
    def initializeGL(self):
        ...
        // 'vs_color' is the color produces by the vertex shader
        in vec4 vs_color;
